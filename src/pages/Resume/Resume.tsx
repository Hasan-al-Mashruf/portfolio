      ...
      <div className="maximum-width">
        <div className="text-white h-screen py-10 relative pt-20 overflow-y-scroll p-5 col-span-2">
          ...
          <div className="content pt-32 grid md:grid-cols-2 gap-14">
            <div>
              <h3 className="text-2xl font-semibold pb-12">
              ...
              <div className="bg-gray-600 rounded-2xl shadow-xl">
                <div className="pb-10 border-b border-b-slate-700 p-8 min-h-[236px]">
                  ...
                  <p className="mt-5 text-sm leading-6 text-[14px]">
                    Skilled in WordPress Elementor, Shopify, React, and
                    Firebase. Created user-friendly websites, collaborating on
                    new features and issue resolution for top performance.
                  </p>
                </div>
                <div className="pb-10 border-b border-b-slate-700 p-8 min-h-[236px]">
                  <h4 className="text-[16px]">
              ...
              <div className="bg-gray-600 rounded-2xl shadow-xl">
                ...
                <div className="pb-10 border-b border-b-slate-700 p-8 min-h-[236px]">
                  ...
                  <p className="mt-5 text-sm leading-6 text-[14px]">
                    ...
                    proficiency in HTML, CSS, Bootstrap, WordPress, and basic
                    PHP into a fulfilling journey of freelancing expertise.
                  </p>
                </div>
                <div className="pb-10 p-8">
                  <h4 className="text-[16px]">
