...
const About: React.FC = () => {
  return (
    <div className="grid grid-cols-6 ">
      <div className="col-span-4 about-section text-white text-center h-screen relative p-10">
        <h1 className="text-xl text-center px-16 leading-[36px] pt-20 relative z-10">
          Hello, I’m a Moeenudin Ahmad, web-developer based on Bangladsh. I have
          rich experience in web site design & building and customization. Also
          I am good at html, css, wordpress, php, jquery, bootstrap.
        </h1>
