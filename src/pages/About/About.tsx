          ...
          <div className="content pt-36 grid md:grid-cols-2 grid-cols-1 gap-10 text-left">
            ...
            <div className="bg-gray-600 rounded-2xl shadow-xl">
              <div className="pb-10 p-8">
                ...
                <p className="mt-5 text-sm leading-6 text-[14px]">
                  Elevating your online presence with captivating website
                  designs using WordPress, Elementor (Free/Pro), Astra, or other
                  themes, blending creativity and technology to engage users and
                  drive results.
                </p>
              </div>
            </div>
            <div className="bg-gray-600 rounded-2xl shadow-xl">
              <div className="pb-10 p-8">
                ...
                <p className="mt-5 text-sm leading-6 text-[14px]">
                  Empowering digital visions with end-to-end MERN stack
                  expertise, combined with Firebase integration, to create
                  dynamic and secure web applications that seamlessly merge
                  powerful front-end interfaces with robust back-end
                  functionality.
                </p>
              </div>
            </div>
